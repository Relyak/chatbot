...
for intent in intents ['intents']:
    for pattern in intent['patterns']:
        # Transforma las palabras en tokens en cada patrón y las añade a la lista de palabras
...
#Lematiza las palabras y las convierte en minúsculas, expluyendo las palabras ignoradas
